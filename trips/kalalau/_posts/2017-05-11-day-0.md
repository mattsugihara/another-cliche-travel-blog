---
title: Back on Kauai
location: [Lihue, Princeville, Kapa'a]
---
...
After Hamura's, we hit up Walmart for propane and snacks. Turns out they only have the Coleman cylinders, so we ended up at [Kayak Kauai](https://kayakkauai.com/), which luckily carries them. As it turned out, we could have just scavenged for them on the trail, but so it goes.
...
We showered off, then went for drinks at the [St. Regis](https://www.1hotels.com/hanalei-bay). At the bar, the bartender asked if I was Ashley's brother. When we facetimed my mom from the bar to wish her a happy birthday, we figured out she's one of Uncle Lotin's grandchildren.
